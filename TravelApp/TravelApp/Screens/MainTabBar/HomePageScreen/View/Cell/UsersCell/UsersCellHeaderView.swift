...
class UsersCellHeaderView: UICollectionReusableView {
    static let headerIdentifier = "cell"
    ...
    @objc func seeAllUsersButtonClicked() {
        delegate?.seeAllUsersButtonTapped()
    }
